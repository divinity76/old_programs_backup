...
{
    std::cout << "im loading IOMapOTMB loadmap..."<<std::endl;
	FileLoader f;
    ...
    std::cout << "attribute is:"<< (attribute==OTBM_ATTR_DESCRIPTION ? "OTBM_ATTR_DESCRIPTION" : "NOT OTBM_ATTR_DESCRIPTION.")<<
    ". and " << (attribute == OTBM_ATTR_EXT_SPAWN_FILE ? "OTBM_ATTR_EXT_SPAWN_FILE." : "NOT OTBM_ATTR_EXT_SPAWN_FILE.")<<std::endl;
		switch(attribute){
