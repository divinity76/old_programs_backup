...
uint32_t MINIMUM_PVP_LEVEL;
///NOTE: player->level is actually int... i write uint anyway.
#endif//HHB_MINIMUM_PVP_LEVEL

#if !defined(YUR_CVS_MODS)
...
///Hacks to make it compilable without YUR_CVS_MODS
#endif//YUR_CVS_MODS
  ...
  void
  #if !defined(HHB_GCC_4X)
  LuaScript::
  #endif//HHB_GCC_4X
      setField (const char *index, int value);
  //static version
