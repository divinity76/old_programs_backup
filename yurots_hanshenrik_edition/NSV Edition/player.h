...
double getFreeCapacity() const {
	...
	void sendChangeSpeed(Creature* creature,uint16_t fakespeed);
#endif//HHB_SLOW_AUTOWALK
	void sendChangeSpeed(Creature* creature);
	void sendToChannel(Creature *creature, SpeakClasses type, const std::string &text, unsigned short channelIdz);
...
*/
	...
	//reminder: 0 = No vocation, 1 = Sorcerer, 2 = Druid, 3 = Paladin, 4 = Knight
