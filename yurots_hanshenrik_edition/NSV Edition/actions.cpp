	...
	const unsigned short itemid, const unsigned char index)
{
	...
	if(!item){
		...
		#endif
		player->sendCancel("You can not use this object.1");
		return false;
	}
	...
	if(item->getID() != itemid){
        ...
        std::cout << "expected ID: \""<<item->getID()<<"\" and recieved ID \""<<itemid<<"\" from client.."<<std::endl;
		#endif
		player->sendCancel("You can not use this object.2");
		return false;
	}
  ...
  player->sendCancel("You can not use this object.3");
  return false;
}
	...
	const unsigned char to_stack,const unsigned short itemid)
{
	...
	//not found
	player->sendCancel("You can not use this object.4");
	return false;
}
