...
public:
	...
	bool creatureBroadcastMessage(Creature* c, const std::string& text);
    ...
    bool playerSetFightModes(/*uint32_t*/Player* player, fightMode_t fightMode, chaseMode_t chaseMode, bool safeMode);
...
#ifdef HHB_PARTY_SYSTEM
//TODO: uint32_t or unsigned long?
