...
bool Map::loadMap(const std::string& identifier, const std::string& type)
{
	...
	if(!loader->loadHouses(this)){
        ...
        std::cout << "I accept this house.xml format only. sorry.\n\n\n"<<std::endl;
std::cout << "<?xml version=\"1.0\"?>\n";
std::cout <<"<houses>\n";
std::cout <<"<house name=\"House Name\" houseid=\"1\" entryx=\"92\" entryy=\"87\" entryz=\"6\" rent=\"1500\" townid=\"1\" size=\"25\"/>\n\n";
std::cout<<"<house name=\"House Name2\" houseid=\"2\" entryx=\"92\" entryy=\"87\" entryz=\"7\" rent=\"1500\" townid=\"1\" size=\"25\"/>\n\n";
std::cout<<"</houses>\n\n\n";
std::cout<<std::flush;
	}
