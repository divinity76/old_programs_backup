...
enum fightMode_t {//this code is unimplemented in parts of the code serv..
	FIGHTMODE_ATTACK=1,
...
public:
	...
	bool canSeeGmInvis(const Creature* creature) const
		{return (creature->getPlayer() && creature->getPlayer()->access <= access);}
#endif
...
void sendCreatureSkull(const Creature* creature) const;
	...
	Item* getItem(slots_t s){return items[s];}
