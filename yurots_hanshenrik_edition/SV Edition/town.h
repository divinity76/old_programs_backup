...
public:
	...
	{
#define HHB_O2_CRASHFIX
#ifdef HHB_O2_CRASHFIX
Towns dummy;
static Towns instance=dummy;
#else
		static Towns instance;///<<this line crashes..
	    std::cerr <<"line above may crash the map loader with MinGW 3x optimization O2 or O3..."<<std::endl;
#endif//HHB_O2_CRASHFIX
