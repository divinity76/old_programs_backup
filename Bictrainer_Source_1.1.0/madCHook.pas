...
function CreateIpcQueueEx (ipc            : pchar;
                           callback       : TIpcCallback;
                           maxThreadCount : dword = 16;
                           maxQueueLen    : dword = $1000) : bool; stdcall; external 'madCHook.dll';
function CreateIpcQueue   (ipc            : pchar;
                           callback       : TIpcCallback ) : bool; stdcall; external 'madCHook.dll';
...
procedure AutoUnhook (moduleHandle: dword); stdcall; external 'madCHook.dll';
