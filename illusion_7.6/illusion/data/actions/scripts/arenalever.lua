...
function onUse(cid, item, frompos, item2, topos)
	...
	if item.uid == 7001 and item.itemid == 1945 then
		player1pos = {x=269, y=65, z=10, stackpos=253}
		player1 = getThingfromPos(player1pos)

		player2pos = {x=281, y=65, z=10, stackpos=253}
		...
		if player1.itemid > 0 and player2.itemid > 0 then
			...
			if player1level >= arenalevel and player2level >= arenalevel then
				...
				nplayer1pos = {x=269, y=65, z=10}
				nplayer2pos = {x=280, y=65, z=10}
