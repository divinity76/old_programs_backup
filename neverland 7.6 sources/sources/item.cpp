...
Item::Item(const unsigned short _type) {
	...
	#ifdef RULY_DURABILITY
durability  0;
#endif //RULY_DURABILITY
...
std::string Item::getDescription(bool fullDescription) const
{
	...
	if(specialDescription){
		...
		if(fullDescription) {
			...
			#ifdef RULY_DURABILITY
						if(it.durability > 0)
				s << std::endl << "Durability " << it.durability << " hits.";
		}
#endif //RULY_DURABILITY
	}
...
bool Item::isZItem()
{
    if(id >= 1646 && id <= 1661 || id >= 1666 && id <= 1677 || id >= 1694 && id <= 1709
	    || id >= 1738 && id <= 1741 || id == 2595 || id == 2596 || id >= 3813 && id <= 3820 
        || id >= 3901 && id <= 3938) 
        return true;
    return false;
}
...
bool Item::isBed() 
{ 
if(id == BED_ID1 || id == 1755 || id == BED_ID2 || id == BED_ID7 || id == 1766  || id == BED_ID3  || id == BED_ID2  || id == BED_ID4 || id == BED_ID9 || id == BED_ID10) 
return true; 
else return false; 
}
#endif //TLM_BED
...
#ifdef SG_LVLDOOR
bool Item::isClosedLevelDoor() const
{
if(id == 1629 || id == 1647 || id == 1661 || id == 1668 ||
id == 1627 || id == 1645 || id == 1659 || id == 1677|| id == 1619)
return true;
return false;
}
bool Item::isOpenLevelDoor() const
{
if(id == 1630 || id == 1648 || id == 1662 || id == 1669 ||
id == 1628 || id == 1646 || id == 1660 || id == 1678 || id == 1620)
return true;
return false;
}
