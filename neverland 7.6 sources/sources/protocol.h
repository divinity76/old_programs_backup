...
public:
  ...
  //Move Up
	...
	virtual void sendBlackBox(const Creature *creature) = 0;
  ...
  virtual void sendUpdateTwoTiles(const Position &from_pos, const Position &to_pos) = 0;
#endif //VITOR_STACKABLE
#ifdef TLM_SKULLS_PARTY
	virtual void sendSkull(const Player *player) = 0;
	...
	virtual void logout() = 0;
     ...
     virtual void sendKick() = 0;
      ...
      virtual void closeChannel(Player *target, int channelId) = 0;
#endif //LOOSIK_PVTCHANNEL
	
	#ifdef THUNDER
    virtual void sendThunderFlash(unsigned char lightlevel, unsigned char color) = 0;
	...
	virtual void sendCommentWindow(const unsigned short maxlen, const unsigned long id, const std::string &text) = 0;
