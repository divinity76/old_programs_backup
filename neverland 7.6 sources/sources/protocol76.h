...
private:
	...
	void parseCancelRVR();	
	  	...
	  	virtual void sendUpdateTwoTiles(const Position &from_pos, const Position &to_pos);
...
//void parseUpdateContainer(NetworkMessage &msg);
	...
	virtual void sendPartyIcons(const Player *playa, int icontype, bool skull, bool removeskull);
	...
	void parsePassLeadership(NetworkMessage &msg);
		...
		void parseCreateChannel();
	void parseChannelInvite(NetworkMessage &msg);
	void parseChannelRemove(NetworkMessage &msg);
...
#ifdef LOOSIK_PVTCHANNEL
	virtual void closeChannel(Player *target, int channelId);
#endif //LOOSIK_PVTCHANNEL
  ...
  const Item* fromItem, Container *toContainer);
	...
	virtual void sendBlackBox(const Creature *creature);
	...
	#ifdef THUNDER
	virtual void sendThunderFlash(unsigned char lightlevel, unsigned char color);
#endif //THUNDER
