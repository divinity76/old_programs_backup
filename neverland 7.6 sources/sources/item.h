...
#ifndef __NVLAND_ITEM_H
#define __NVLAND_ITEM_H
...
void setWriter(std::string name);
	...
	#ifdef DT_IT
	static Item* CreateItemByName(std::string _name, unsigned short _count /*= 0*/);
#endif //DT_IT
	static Items items;
	...
	#ifdef SG_LVLDOOR
		bool isClosedLevelDoor() const;
bool isOpenLevelDoor() const;
