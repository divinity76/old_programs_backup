...
function onCreatureSay(cid, type, msg)
	...
	elseif focus == cid then
		...
		if msgcontains(msg, 'amulets')  then
  			...
  			selfSay('I sell Great Axes (150k), Stonecutters Axes (180k), Guardian Halberds (15k), Fire Axes (20k), Knight Axes (4k), Double Axes (400gp) and Battle Axes (200gp), Dragon Lances (20k), Halberds (400gp) and Hatchets (40gp).')
		...
		elseif msgcontains(msg, 'blessed shield') then
			buy(cid,2523,1,300000)
		elseif msgcontains(msg, 'great shield') then
			buy(cid,2522,1,200000)
