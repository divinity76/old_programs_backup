 ...
 function msgcontains(txt, str)
  ...
  function onCreatureSay(cid, type, msg)
  	...
  	if ((string.find(msg, '(%a*)hi(%a*)')) and (focus == 0)) and getDistanceToCreature(cid) < 3 then
  		selfSay('Hello ' .. creatureGetName(cid) .. '! I am the famous Robin Hood and i want sell crossbows (200gps), bows (100gps), arrows (100gps), bolts (150gps), powerbolt (200gp), burst (350gps) and spears (100gps). All the money that i gain is for the poor people')
  		focus = cid
  		talk_start = os.clock()
  	end
