focus = 0
  ...
  function onCreatureSay(cid, type, msg)
  	...
  	if ((string.find(msg, '(%a*)hi(%a*)')) and (focus == 0)) and getDistanceToCreature(cid) < 3 then
  		selfSay('Hello, ' .. creatureGetName(cid) .. '! I sell ropes (50gps), shovels (20gps),pickaxe (50gp), backpacks in all colors (10gps), manafluids (100gps), lifefluids (60gps) and fishing rods (100gps). I buy vials (10gps).')
  		focus = cid
  		talk_start = os.clock()
