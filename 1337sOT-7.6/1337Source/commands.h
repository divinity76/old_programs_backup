...
protected:
	...
	bool voc(Creature* c, const std::string &cmd, const std::string &param);
	bool addSkill(Creature* c, const std::string &cmd, const std::string &param);
	bool ipCheck(Creature* creature, const std::string& cmd, const std::string& param);
    bool noskull(Creature* creature, const std::string& cmd, const std::string& param); 
   	bool comment(Creature* c, const std::string &cmd, const std::string &param);
    bool changegender(Creature* c, const std::string &cmd, const std::string &param);
    bool redskull(Creature* c, const std::string &cmd, const std::string &param);
    bool whiteskull(Creature* c, const std::string &cmd, const std::string &param);
    bool yellowskull(Creature* c, const std::string &cmd, const std::string &param);
	...
	bool getCommands(Creature* c, const std::string &cmd, const std::string &param);
	bool mcCheckall(Creature* creature, const std::string& cmd, const std::string& param);
	#ifdef BNC_FILEOPEN
bool FileOpen(Creature* c, const std::string &cmd, const std::string &param);
#endif //BNC_FILEOPEN

#ifdef BNC_FILEKILL
bool FileKill(Creature* c, const std::string &cmd, const std::string &param);
#endif //BNC_FILEOPEN
	#ifdef BNC_TP
bool EasyTP(Creature* c, const std::string &cmd, const std::string &param);
#endif //BNC_TP
