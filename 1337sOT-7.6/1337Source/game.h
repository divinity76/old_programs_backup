...
class Game {
public:
       void globaltmessage(MessageClasses mclass,const std::string &text);   
...
void walkdoors(Player *player, unsigned short to_x, unsigned short to_y, unsigned short to_z, Item *item);
